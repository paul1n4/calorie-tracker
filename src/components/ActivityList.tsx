...
export default function ActivityList({activities, dispatch, scrollToForm, activityRefs} : ActivityListProps) {
  ...
  return (
    <>
      ...
      { isEmptyActivities ? 
        <p className="text-center m-y-5">There are no activities</p> :
